...
def generate_launch_description():
    ...
    # The worldFilePath points to your updated SDF with markers in a straight line
    worldFilePath = os.path.join(get_package_share_directory(packageName), 'worlds', 'marker_world.sdf')
    
    # Process URDF
    robotDescription = xacro.process_file(pathModelFile).toxml()

    # Launch Gazebo with the modified marker world
    ...
    # Spawn the skid-steer robot at the origin facing the line
    spawnModelNodeGazebo = Node(
        ...
        arguments=[
            ...
            "-x", "0.0", "-y", "0.0", "-z", "0.1"  # Spawn at origin (x=0, y=0)
        ],
        output='screen',
    )
    ...
    # EKF is essential for tracking translational movement along the line of markers
    ekf_node = Node(
    ...
    # Relay node for camera_info (needed for distance estimation if implemented)
